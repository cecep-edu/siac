...
class Controller_Infopersonal extends Controller_Template {
    ...
    public function action_view() {
        ...
        $data['instrucciones'] = $personal->instrucciones;
        $data['laborales'] = $personal->laboral;
        $data['capacitaciones'] = $personal->capacitacion;
        $data['idiomas'] = $personal->idioma;
        $data['publicaciones'] = $personal->publicacion;
        $data['proyectos'] = $personal->proyecto;
        $data['tesis'] = $personal->tesis;
